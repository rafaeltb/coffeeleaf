...
def cnn_model(model_name, pretrained=False, num_classes=(5, 5)):
    ...
    #if model_name == 'efficientenetb0':
    #    model = efficientnet_b0(pretrained=pretrained, num_classes=num_classes)  
    #if model_name == 'efficientenetb1':
    #    model = efficientnet_b1(pretrained=pretrained, num_classes=num_classes) 
    #if model_name == 'efficientenetb2':
    #    model = efficientnet_b2(pretrained=pretrained, num_classes=num_classes) 
    #if model_name == 'efficientenetb3':
    #    model = efficientnet_b3(pretrained=pretrained, num_classes=num_classes) 
    #if model_name == 'efficientenetb4':
    #    model = efficientnet_b4(pretrained=pretrained, num_classes=num_classes) 
    #if model_name == 'efficientenetb5':
    #    model = efficientnet_b5(pretrained=pretrained, num_classes=num_classes) 
    #if model_name == 'efficientenetb6':
    #    model = efficientnet_b6(pretrained=pretrained, num_classes=num_classes) 
    if model_name == 'efficientenetbx':
        #model = efficientnet_b7(pretrained=pretrained, num_classes=num_classes) 
...
class MultiTaskClf:
    ...
    def train(self, train_loader, model, criterion, optimizer, data_augmentation=None):
	    ...
	    if model_name == 'efficientenetbx':
            	outputs_sev = model(images)
            	outputs_dis = model(images)
	    else:
